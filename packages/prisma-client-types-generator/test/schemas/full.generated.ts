...
export type MediaRelations = {
  postToMedias: PostToMediaExtended[];
};
...
export type CategoryRelations = {
  childrenCategories: CategoryExtended[];
  parentCategory: CategoryExtended | null;
  Post: PostExtended[];
};
...
export type UserRelations = {
  ...
  settings: UserSettingsExtended | null;
};
